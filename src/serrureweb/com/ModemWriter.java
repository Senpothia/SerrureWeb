...
public class ModemWriter implements Runnable, Observer {
    ...
    public Controleur getControleur() {
        ...
        if (this.controleur == null) {
            ...
            this.controleur.setActifs(this.actifs);
            this.controleur.initTotaux(totaux);
            SerrureWeb.marche = true;
    ...
    public void run() {
        ...
        System.out.println("Lancement recepteur");
        try {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (serrureweb.SerrureWeb.marche) {

            rapport = rapport + "MARCHE>";
        }

        if (!serrureweb.SerrureWeb.marche && !serrureweb.SerrureWeb.pause) {

            rapport = rapport + "ARRET>";
        }
        if (serrureweb.SerrureWeb.pause) {
